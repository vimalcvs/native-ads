...
public class NativeSmall extends FrameLayout {
  ...
  public NativeSmall(Context context) {
    super(context);
  }

  public NativeSmall(Context context, @Nullable AttributeSet attrs) {
    super(context, attrs);
    initView(context, attrs);
  }

  public NativeSmall(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
